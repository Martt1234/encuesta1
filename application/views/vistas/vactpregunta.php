<div class="row">
  ...
  <div class= "col-md-4">
    <div class="well"><!--sombreado-->
      <center>
        <br><br>
        <div id= "titulo2"><h1>Actualizar Preguntas</h1></div>
           <br><br>
    ...
    <tbody>
        ...
        <?php foreach($result as $row) {?>
                ...
                <td><?php echo $row->descripcion; ?></td>
                 ...
                 <td><a class="btn btn-outline-success" href= "<?php echo site_url('Controller1/editarpregunta'); ?>/<?php echo $row->id;?>"role="button">Actualizar</a>
                <?php } ?>
     </tbody>
    </table>
